...
/**
 * @brief  Compares two persons in this sequence: 1st=name, 2nd=first_name,
 * 3rd=age
 ...
 *         >0 if all previous fields are the same, but for this field, a is
 * greater <0 if all previous fields are the same, but for this field, b is
 * greater
